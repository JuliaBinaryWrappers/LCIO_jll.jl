# Autogenerated wrapper script for LCIO_jll for x86_64-linux-gnu-cxx03
...
const libsio_splitpath = ["lib", "libsio.so"]
...
const libsio = "libsio.so.2.13"


# Relative path to `liblcio`
const liblcio_splitpath = ["lib", "liblcio.so"]
