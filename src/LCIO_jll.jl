...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LCIO_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("35fd387a-780d-5580-bc3c-2dd06d6487c2"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LCIO", artifacts_toml) for e in artifacts["LCIO"]]
...
if best_platform === nothing
    @debug("Unable to load LCIO; unsupported platform $(triplet(platform_key_abi()))")
else
